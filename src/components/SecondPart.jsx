...
const SecondPart = () => {
  return (
    ...
    <div className='bg-neutral-950 text-white justify-center text-center'>
        ...
        <h3 
        className='text-3xl/10 font-sans font-medium p-2'

        >More then just a resturant</h3>
        <hr className='p-5 sm:hidden'></hr>
        <h6 className='text-xl p-1 font-bold '>ABOUT THE RESTAURANT</h6>
        <p className='text-sm p-4'>Our journey is rooted in a love for fresh, high-quality ingredients and a dedication to crafting dishes that blend tradition with innovation.</p>
         <motion.button 
                className="px-3 py-2 bg-white/10 backdrop-blur-lg border border-white/40 text-white rounded-xs shadow-md cursor-pointer z-40 relative text-sm sm:text-lg"
                whileHover={{ 
                  scale: 1.05,
